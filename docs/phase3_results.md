# Phase 3 Results: Additional Feature Sources
...
| + intl H2H / Phase 1 | 39 | 0.534 | 0.40 | 0.625 | 0.578 | 0.40 |
| + FIFA rankings (3b) | 38-42 | 0.483-0.505 | 0.23-0.29 | -- | -- | -- |
| + qualifying record (3c) | 38-42 | 0.510-0.522 | 0.39-0.45 | -- | -- | -- |
| + all Phase 3 combined | 47 | 0.460 | 0.14 | 0.578 | 0.469 | 0.10 |

## Phase 3a: Continent Advantage -- HELPS (marginally)
...
However: does NOT combine well with intl H2H. Adding continent to Phase 1 (intl H2H) drops CV F1 to 0.506. The two features compete for similar geographic/relational signal.

## Phase 3b: FIFA Rankings -- HURTS
...
## Phase 3c: Qualifying Record -- NEUTRAL
...
## Phase 3d: Squad Market Value -- DOES NOT HELP
...
## Final Results: All Phases Combined
...
| + all Phase 3 combined | 47 | 0.460 | 0.14 | 0.578 | 0.469 |
